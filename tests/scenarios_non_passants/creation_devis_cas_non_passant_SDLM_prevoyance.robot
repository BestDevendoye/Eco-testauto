...
Resource    ../../pages/creation_devis_page_non_passant.robot
...
Resource        ../../tests/resources/jdd_devis_non_passant.robot
...
Formulaire Devis-Entreprise-Offre SDLM prévoyance non passant
    ...
    Renseigner un pays et vérifer le message d'erreur puis remettre France    ${pays_entreprise}
