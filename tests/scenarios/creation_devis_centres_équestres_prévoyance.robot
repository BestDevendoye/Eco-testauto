...
Formulaire Devis-Accès-Offre équestres prévoyance
    Log To Console    Step-02-Clic sur Séquestres prévoyance
 ...
 Formulaire Devis-Entreprise-Offre équestres prévoyance
    Log To Console    Step-03-Remplissage des champs Entreprise  équestres prévoyance
...
Formulaire Devis-Signataires-Offre équestres prévoyance
    Log To Console    Step-04-Remplissage des champs Signataire équestres prévoyance
...
Tarificateur équestres prévoyance
    Log To Console    Step-06-Remplissage des champs Tarificateur équestres prévoyance
    Set Selenium Speed    1s
    Sélectionner la réponse NON à la question l’entreprise relève de la CCN du personnel non cadre des centres équestres prévoyance    ${valeur_champ_entreprise_NON}
    Vérifier la présence du message si la réponse est non_équestres_prévoyance
    Sélectionner la réponse OUI à la question l’entreprise relève de la CCN du personnel non cadre des centres équestres prévoyance     ${valeur_champ_entreprise_OUI}
    Vérifier la valeur du champ entreprise relevant de la CCN du personnel non cadre des centres équestres prévoyance     ${valeur_champ_entreprise_OUI}
    Sélectionner le niveau de garantie que l'entreprise souhaite apporter à ses salariés  ${valeur_champ_niveau_garantie}
    Renseigner l'effectif non cadre à assurer prévoyance     ${valeur_champ_effectif_a_assurer_centres_prévoyance}
    Renseigner la masse salariale prévoyance      ${valeur_masse_salariale_centres_prévoyance}
    ...
    Vérifier si l'offre sélectionnée est bien affichée dans la partie Résumé    ${offre_selectionnee_centres_prévoyance}
    Cliquer sur le bouton Enregistrer
    Set Selenium Speed    0s

Envoi de la proposition commerciale-Offre équestres prévoyance
    Log To Console    Step-07-Envoi de la proposition  équestres prévoyance
    Vérifier le titre de la page Synthèse       Centres équestres Prévoyance        Synthèse de la proposition commerciale et envoi au client
