...
Formulaire Devis-Accès-Offre RÉGIME D’ADHÉSION
    Log To Console    Step-02-Clic sur RÉGIME D’ADHÉSION
...
Tarificateur RÉGIME D’ADHÉSION
    ...
    Vérifier le niveau de garantie_régime_adhésion    ${valeur_champ_niveau_garantie}
    Vérifier le régime de base régime_adhésion        ${champ_regime_base}
    Sélectionner la réponse NON à la question chambre d'agriculture régime_adhésion   ${valeur_champ_entreprise_NON}
    Vérifier si la valeur du champ chambre agruculture est NON régime_adhésion   ${valeur_champ_entreprise_NON}
    Renseigner le nbr de salariés régime_adhésion         ${champ_nbr_salaris_reg_adhesion}
    Renseigner la masse salariale TA régime_adhésion      ${valeur_masse_salariale_TA_reg_adhesion}
    Renseigner la masse salariale TB régime_adhésion      ${valeur_masse_salariale_TB_reg_adhesion}
    Renseigner la masse salariale TC régime_adhésion      ${valeur_masse_salariale_TC_reg_adhesion}
    ...
    Vérifier si l'offre sélectionnée est bien affichée dans la partie Résumé    ${offre_selectionnee_régime_adhésion}
    Cliquer sur le bouton Enregistrer
    Set Selenium Speed    0s

Envoi de la proposition commerciale-Offre RÉGIME D’ADHÉSION
    Log To Console    Step-07-Envoi de la proposition
    Vérifier le titre de la page Synthèse     Régime d’adhésion   Synthèse de la proposition commerciale et envoi au client
