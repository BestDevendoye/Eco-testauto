...
Formulaire Devis-Accès-Offre PER CPCEA - SUPPLÉMENT DE TAUX
    Log To Console    Step-02-Clic sur PER CPCEA - SUPPLÉMENT DE TAUX
...
Tarificateur PER CPCEA - SUPPLÉMENT DE TAUX
    ...
    Vérifier le niveau de garantie PER CPCEA - SUPPLÉMENT DE TAUX   ${valeur_niveau_garantie_per_cpcea}
    Sélectionner le collège à assurer PER CPCEA - SUPPLÉMENT DE TAUX   ${valeur_type_college_per_cpcea}
    Sélectionner l'accord PER CPCEA - SUPPLÉMENT DE TAUX         ${valeur_type_accord_per_cpcea}
    Renseigner le nbr effectif à assurer PER CPCEA - SUPPLÉMENT DE TAUX     ${valeur_effectif_assurer_per_cpcea}
    Renseigner la masse annuelle TA PER CPCEA - SUPPLÉMENT DE TAUX     ${valeur_masse_TA_per_cpcea}
    Renseigner la masse annuelle TB PER CPCEA - SUPPLÉMENT DE TAUX     ${valeur_masse_TB_per_cpcea}
    Renseigner la masse annuelle TC PER CPCEA - SUPPLÉMENT DE TAUX     ${valeur_masse_TC_per_cpcea}
    Renseigner la masse annuelle TC Sup PER CPCEA - SUPPLÉMENT DE TAUX    ${valeur_masse_TC_Sup_per_cpcea}
#    Cliquer sur la cellule tab_taux PER CPCEA - SUPPLÉMENT DE TAUX
    Verifier la date d'effet de contrat        ${date_effet_contrat_cpcea}
    Vérifier si la valeur de la date d'effet de contrat est correcte    ${date_effet_contrat_cpcea}
    Cliquer sur le bouton Suivant
    Vérifier si l'offre sélectionnée est bien affichée dans la partie Résumé    ${offre_selectionnee_per_cpcea_taux}
...
Envoi de la proposition commerciale-Offre PER CPCEA - SUPPLÉMENT DE TAUX
    ...
    Vérifier le titre de la page Synthèse     PER CPCEA - supplément de taux   Synthèse de la proposition commerciale et envoi au client
