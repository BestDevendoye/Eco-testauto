...
Tarificateur ACCORD NATIONAL DE LA COOPERATION AGRIGOLE ET DES INDUSTRIES
    ...
    Sélectionner la réponse NON à la question entreprise relevant de l'accord collectif national    ${valeur_champ_entreprise_NON}
    Vérifier la présence du message si la réponse Accord collectif national est non
    Vérifier si la valeur du champ NON entreprise relevant de l'Accord collectif national      ${valeur_champ_entreprise_NON}
    Sélectionner la réponse OUI à la question entreprise relevant de l'Accord collectif national   ${valeur_champ_entreprise_OUI}
    Vérifier si la valeur du champ OUI entreprise relevant de l'Accord collectif national      ${valeur_champ_entreprise_OUI}
    Sélectionner le niveau de garantie de l'Accord collectif national      ${valeur_champ_niveau_garantie}
    Sélectionner le type de cotisations de l'Accord collectif national    ${type_cotisations_accord_national}
    Sélectionner le type de structure tarifaire de l'Accord collectif national    ${type_structure_accord_national}
    ...
    Vérifier si l'offre sélectionnée est bien affichée dans la partie Résumé    ${offre_selectionnee_accord_national_cooperation}
